								...
								<form class="admin_form" method="post" >
									<table>
										<tr>
											...
											<td>
												<input type="text" id="name" name="name" value class="t_input" />
											</td>
										</tr>
										<tr>
										<th>性别</th>
										<td><label for="sexm">
												...
												男</label>
											<label for="sexw">
												<input id="sexw" type="radio" value="2" name="sex">
												女</label>
                                             											<span style="font-weight:bold;color:red;">(确定后无法再次修改)</span></td>
									</tr>
									<tr>
										<th>婚恋状态</th>
                                    ...
                                    <script>
                                        $("#birthcitybox").citySelect({nodata:"none",required:false});
                                        $("#residecitybox").citySelect({nodata:"none",required:false});
                                    </script>
									<tr>
										<td colspan="2"><input type="submit" name="profilesubmit" value="保存" class="infosubmit"></td>
									</tr>
									</table>
								</form>
							</div>
