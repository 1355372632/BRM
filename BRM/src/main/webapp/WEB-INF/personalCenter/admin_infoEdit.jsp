						...
						<div class="databox">
							<form class="admin_form" method="post" action="userInfoController/editInfo">
								<table>
									...
									<tr>
										<th>性别</th>
										<td><label for="sexm"> <input id="sexm"
												type="radio" value="1" name="sex"> 男
										</label> <label for="sexw"> <input id="sexw" type="radio"
												value="2" name="sex"> 女
										</label> <span style="font-weight: bold; color: red;">(确定后无法再次修改)</span></td>
									</tr>
									<tr>
										<th>婚恋状态</th>
									...
									<tr>
										...
										</select> 年 <select id="birthmonth" name="birthmonth">
												<option value="0">&nbsp;</option>
										...
										</select> 月 <select id="birthday" name="birthday">
												<option value="0">&nbsp;</option>
												<option value="1">1</option>
												<option value="2">2</option>
												<option value="3">3</option>
									...
									<script>
										...
										$("#residecitybox").citySelect({
											nodata : "none",
											required : false
										});
									</script>
									<tr>
										<td colspan="2"><input type="submit" name="profilesubmit"
											value="保存" class="infosubmit"></td>
									</tr>
								</table>
							</form>
						</div>
